...
public class Human {
    ...
    /**
     *  static - ключевое слово, которое означает, что сущность принадлежит классу, а не объекту
     *  final -  ключевое слово, которое означает, что сущность нельзя изменить, обычно final помечаются константы
     */
    public static final double PI = 3.14;

    public static void sayHelloNew(){
